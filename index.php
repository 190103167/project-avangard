...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <div class="all2">
        <div class="first">
          <img src="img/newyear.jfif" width="350px" height="360px">
  ...
  the best online store in <br> Kazakhstan - it is located at
    ...
    <footer>
      <div class="end">
        ...
        <div class="end4">
          ...
          <a href="">Contacts</a>
          <a href="http://localhost/tasks/admin.html">ADMIN</a>
    ...
    <div class="footer1">
      ...
      <div>
        <button type="button" name="button" class="set">SIGN UP!</button>
