...
?>
    <div class="container">
      ...
      <a class="fas fa-shopping-basket" id="checkout" href="http://localhost/tasks/proverka1.php"></a>
    ...
    <div class="set">
      <div class="set1">
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple <?php
    $stid = oci_parse($conn, 'SELECT product_name, price FROM products where product_id=3');
    oci_execute($stid);
...
?> Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price"><?php  echo $row[1]?> Tg</h2>
          <a href="http://localhost/tasks/proverka2.php"><img width="30px" class="icon4" src="https://image.flaticon.com/icons/png/512/2/2772.png"/></a>
      ...
      <div class="set2">
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple <?php
    $stid = oci_parse($conn, 'SELECT product_name, price FROM products where product_id=2');
    oci_execute($stid);
    $row = oci_fetch_array($stid);
    echo $row[0]
?></p>
...
?></p>
        ...
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple
            <?php
    $stid = oci_parse($conn, 'SELECT product_name, price FROM products where product_id=2');
    oci_execute($stid);
    $row = oci_fetch_array($stid);
...
?>
    ...
    $stid = oci_parse($conn, 'SELECT product_name, price FROM products where product_id=12');
    oci_execute($stid);
    $row = oci_fetch_array($stid);
    echo $row[0]
?></p>
